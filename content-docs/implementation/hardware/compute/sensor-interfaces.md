...
Ethernet-based LiDAR sensor for 360Â° scanning.
...
**ROS 2 Topics:**
- `/lidar_hinson_se_1035/scan` - `sensor_msgs/LaserScan` (0-361Â° range)
...
- Set via LCD: Menu â†’ Password (0001) â†’ Communication â†’ MODBUS â†’ Address â†’ 003
...
**Configuration:**
- Modbus Address: 2
- Set via LCD: Mode â†’ A01 â†’ Up key â†’ A02 â†’ OK
